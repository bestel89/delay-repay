        ...
        return (
                <main className="max-w-6xl mx-auto px-4 py-10">
                        <article className="prose max-w-none">
                                <header className="mb-8">
                                        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                                                <div className="space-y-3">
                                                        ...
                                                        <h1>UK Train Delay Compensation Explained Simply (2025 Guide)</h1>
                                                ...
                                                <div className="card bg-base-200 shadow-lg w-full lg:w-80">
                                ...
                                <section className="grid gap-6 lg:grid-cols-[320px,1fr] mb-10">
                                ...
                                <section id="thresholds" className="mb-10">
                                        <div className="card bg-base-100 shadow">
                                                <div className="card-body">
                                ...
                                <section id="missed-connections" className="mb-10">
                                        <div className="card bg-base-100 shadow">
                                                <div className="card-body space-y-3">
                                ...
                                <section id="season-tickets" className="mb-10">
                                        <div className="card bg-base-100 shadow">
                                                <div className="card-body space-y-3">
                                ...
                                <section id="when-you-cant-claim" className="mb-10">
                                        <div className="card bg-base-100 shadow">
                                                <div className="card-body space-y-3">
