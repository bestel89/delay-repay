	...
	return (
		<main className="space-y-12">
			<section className="relative isolate overflow-hidden rounded-2xl bg-slate-900 text-white shadow-sm">
				...
				<div
					className="relative mx-auto flex min-h-[32vh] max-w-6xl flex-col justify-center gap-5 px-6 py-12 md:min-h-[38vh] md:px-10">
					...
					<p className="text-xs text-slate-200/80">
						...
						<a className="underline"
							 href="https://www.pexels.com/photo/red-train-at-birmingham-new-street-station-35432879/"
			...
			<section id="calculator" className="space-y-6">
				<div className="space-y-3">
					...
					<p className="text-slate-700">
						Enter the ticket price, ticket type, operator, and delay length. The estimator applies the operator’s
						published percentages. For season products we convert to a per-journey figure before applying the band.
					</p>
				</div>
				...
				<p className="text-sm text-slate-600">Results are indicative only. Your train operator confirms eligibility and
					the final payment.</p>
			</section>
